...
**모니터링**은 서버 운영 환경을 단순화해 구현한 서버 모니터링 프로젝트입니다.
...
**모니터링**은 작은 규모의 개인 프로젝트이지만, 단순 CRUD가 아니라 서버 운영에 필요한 여러 요소를 함께 다루고자 했습니다.

서버 상태 감시, 상태 저장, 캐싱, 운영 Dashboard, 컨테이너 실행 환경, CI 자동화까지 연결하면서 실제 서버 관리 도구의 축소판을 구현했습니다.

이 프로젝트를 통해 C#과 .NET 기반 서버 개발뿐 아니라, 운영 환경을 고려한 구성과 문제 해결 과정을 학습할 수 있었습니다.
